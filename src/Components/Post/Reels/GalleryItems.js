    ...
    <div>
      <div className='tablist-container'>
        <div className='tablist'>
          <i class='far fa-th'></i>
          <span className='tablist-item'>Posts</span>
        </div>
        <div className='tablist'>
          <svg
            aria-label=''
          ...
          <span className='tablist-item'>Reels</span>
        </div>
        <div className='tablist'>
          <svg
            aria-label=''
          ...
          <span className='tablist-item'>Videos</span>
        </div>
        <div className='tablist'>
          <svg
            aria-label=''
          ...
          <span className='tablist-item'>Tagged</span>
        </div>
      </div>
    </div>
  );
