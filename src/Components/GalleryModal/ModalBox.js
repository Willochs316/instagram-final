...
const ModalBox = ({ slides }) => {
  ...
  return (
    <>
      <div className='gallery_modal-container'>
        ...
        <div className='modal-sidebar'>
          {userFigures(3).map((slide) => (
            <div className='modal-nav'>
              ...
              <div className='upload_icon'>
                <Svgs.EllipsisUploadIcon className='icons' />
              </div>
            </div>
          ))}
          ...
          <div className='news-icons'>
            <div className='icon-btn'>
              <div className='upload_icon'>
                <Svgs.LoveUploadIcon className='icons' width='24' height='24' />
              </div>

              <div className='upload_icon'>
                <Svgs.CommentUploadIcon className='icons' />
              </div>
            ...
            <div className='upload_icon'>
              <Svgs.BookUploadIcon className='icons' />
            </div>
          </div>
          ...
          <div className='addComment-container'>
            <div className='upload_icon'>
              <Svgs.EmojiUploadIcon className='icons' />
            </div>
